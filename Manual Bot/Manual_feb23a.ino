...
void loop() {
  ...
  if(ps2x.ButtonPressed(PSB_CIRCLE))  //Triangle pressed
  {
  ...
  else if(ps2x.ButtonPressed(PSB_PAD_RIGHT))  //Triangle pressed
  {
    //
    Serial.println("Right");
    right();
...
//void rotateOpen(int enVal0)
//{  
//
//  int rotSpeed = map(rotVolt,0,24,0,255);
//  while(abs(enVal-enVal0) <= ppr/2 )
//  {
//    Serial.println(enVal);
//    digitalWrite(rotDir,HIGH);
//    analogWrite(rotPWM,rotSpeed);
//  }
////  enVal = 0;
//  rotateStop();
//}
//
//void rotateClose(int enVal0)
//{
//  int rotSpeed = map(rotVolt,0,24,0,255);
//  while(abs(enVal-enVal0) <= ppr/2 )
//  {
